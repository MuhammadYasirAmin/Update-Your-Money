                    ...
                    <div class="row cta__space">
                        <div class="col-lg-7">
                            <div class="daily-profit column__space">
                                <p class="secondary content__space--small">Daily Profit</p>
        ...
        <div class="container">
            <div class="investment__area">
                ...
                <div class="row content__space">
                        ...
                        <div class="investment__item column__space--secondary">
                            <div class="investment__item__inner">
                                ...
                                <div class="investment__item__content text-center">
                                    ...
                                    <a href="javascript:void(0)" class="button">Start Invest Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="investment__item column__space">
                            <div class="investment__item__inner">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xl-3">
                        <div class="investment__item column__space--secondary">
                            <div class="investment__item__inner">
                                <img src="{{ asset('assets/images/investment/spo-14.png') }}" alt="Spo-14" />
                                <div class="investment__item__content text-center">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="investment__item column__space--secondary">
                            <div class="investment__item__inner">
                                <img src="{{ asset('assets/images/investment/spo-15.png') }}" alt="Spo-15" />
                                <div class="investment__item__content text-center">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="investment__item column__space">
                            <div class="investment__item__inner">
                                <img src="{{ asset('assets/images/investment/spo-16.png') }}" alt="Spo-16" />
                                <div class="investment__item__content text-center">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="investment__item">
                            <div class="investment__item__inner">
                                <img src="{{ asset('assets/images/investment/spo-17.png') }}" alt="Spo-17" />
                                <div class="investment__item__content text-center">
        ...
        <div class="container">
            <div class="testimonial__area">
                ...
                <div class="testimonial__item__wrapper">
                    <div class="testimonial__item bg__img" data-background="{{ asset('assets/images/testimonial/quotation.png') }}">
